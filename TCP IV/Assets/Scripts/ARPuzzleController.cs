...
{
    [Header(" Elements ")]
    private ARPuzzleGenerator arPuzzleGenerator;
    ...
    public void Configure(ARPuzzleGenerator arPuzzleGenerator, float gridScale)
    {
        this.arPuzzleGenerator = arPuzzleGenerator;
    ...
    public bool SingleTouchBeganCallback(Vector3 worldPosition)
    {
        ...
        PuzzlePiece[] puzzlePieces = arPuzzleGenerator.GetPuzzlePieces();
